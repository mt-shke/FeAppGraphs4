...
const IndexPageLeftContainer: React.FC = () => {
   return (
      <div className="min-h-screen flex flex-1 py-1 md:min-h-max md:row-start-1 md:row-end-2 lg:col-start-1 lg:row-span-1 lg:col-end-3">
         <section className="flex flex-1 flex-col md:flex-row lg:flex-col gap-2 p-2 bg-main-grey4 rounded text-white">
            <Container customStyle="flex h-2/5 md:h-full lg:h-1/3 bg-main-black2 overflow-y-scroll">
               <article className="flex flex-1 flex-col gap-3 p-2">
            ...
            <Container customStyle="flex h-3/5 md:h-full lg:h-2/3 bg-main-grey overflow-y-scroll">
               <article className="flex flex-1 flex-col gap-3 p-2">
                  <h2 className="font-bold">Our Vision at Applytics.</h2>
                  <p>
                     ...
                     perfectly with our vision at Applitycs to redefine
                     `}
